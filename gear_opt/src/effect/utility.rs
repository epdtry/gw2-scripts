...
// Generated by gen_gear_tables.py for GW2 build 142239 at 2023-03-08T15:25:18
...
impl Utility {
    ...
    pub fn index(self) -> usize {
        match self {
            ...
            Utility::BountifulSharpeningStone(BountifulSharpeningStone) => 1,
            Utility::BountifulTuningCrystal(BountifulTuningCrystal) => 2,
            Utility::CorsairMaintenanceOil(CorsairMaintenanceOil) => 3,
            Utility::CorsairSharpeningStone(CorsairSharpeningStone) => 4,
            Utility::CorsairTuningCrystal(CorsairTuningCrystal) => 5,
            Utility::EnhancedLucentOil(EnhancedLucentOil) => 6,
            Utility::FuriousMaintenanceOil(FuriousMaintenanceOil) => 7,
            Utility::FuriousSharpeningStone(FuriousSharpeningStone) => 8,
            Utility::FuriousTuningCrystal(FuriousTuningCrystal) => 9,
            Utility::HolographicSuperApple(HolographicSuperApple) => 10,
            Utility::HolographicSuperCheese(HolographicSuperCheese) => 11,
            Utility::HolographicSuperDrumstick(HolographicSuperDrumstick) => 12,
            Utility::HylekMaintenanceOil(HylekMaintenanceOil) => 13,
            Utility::KraitTuningCrystal(KraitTuningCrystal) => 14,
            Utility::MagnanimousMaintenanceOil(MagnanimousMaintenanceOil) => 15,
            Utility::MagnanimousSharpeningStone(MagnanimousSharpeningStone) => 16,
            Utility::MagnanimousTuningCrystal(MagnanimousTuningCrystal) => 17,
            Utility::OgreSharpeningStone(OgreSharpeningStone) => 18,
            Utility::PotentLucentOil(PotentLucentOil) => 19,
            Utility::PotionOfKarkaToughness(PotionOfKarkaToughness) => 20,
            Utility::ToxicFocusingCrystal(ToxicFocusingCrystal) => 21,
            Utility::ToxicMaintenanceOil(ToxicMaintenanceOil) => 22,
            Utility::ToxicSharpeningStone(ToxicSharpeningStone) => 23,
        }
    }
