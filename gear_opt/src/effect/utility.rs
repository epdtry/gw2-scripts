...
// Generated by gen_gear_tables.py for GW2 build 142239 at 2023-03-07T16:46:53
...
impl Vary for NoUtility {
    ...
    fn num_field_values(&self, _field: usize) -> usize { panic!() }
    fn set_field(&mut self, _field: usize, _value: usize) { panic!() }
}
impl NoUtility {
...
impl Vary for Utility {
    ...
    fn num_field_values(&self, _field: usize) -> usize { 24 }
    fn set_field(&mut self, _field: usize, value: usize) {
        *self = Utility::from_index(value);
    }
}
