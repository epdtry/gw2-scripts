...
// Generated by gen_gear_tables.py for GW2 build 142239 at 2023-03-07T15:53:01
...
impl Vary for Utility {
    fn vary_at<T: ?Sized>(
        ...
        let old = *proj(base);
        *proj(base) = Utility::NoUtility(NoUtility);
        f(base);
        *proj(base) = Utility::BountifulSharpeningStone(BountifulSharpeningStone);
        f(base);
        *proj(base) = Utility::BountifulTuningCrystal(BountifulTuningCrystal);
        f(base);
        *proj(base) = Utility::CorsairMaintenanceOil(CorsairMaintenanceOil);
        f(base);
        *proj(base) = Utility::CorsairSharpeningStone(CorsairSharpeningStone);
        f(base);
        *proj(base) = Utility::CorsairTuningCrystal(CorsairTuningCrystal);
        f(base);
        *proj(base) = Utility::EnhancedLucentOil(EnhancedLucentOil);
        f(base);
        *proj(base) = Utility::FuriousMaintenanceOil(FuriousMaintenanceOil);
        f(base);
        *proj(base) = Utility::FuriousSharpeningStone(FuriousSharpeningStone);
        f(base);
        *proj(base) = Utility::FuriousTuningCrystal(FuriousTuningCrystal);
        f(base);
        *proj(base) = Utility::HolographicSuperApple(HolographicSuperApple);
        f(base);
        *proj(base) = Utility::HolographicSuperCheese(HolographicSuperCheese);
        f(base);
        *proj(base) = Utility::HolographicSuperDrumstick(HolographicSuperDrumstick);
        f(base);
        *proj(base) = Utility::HylekMaintenanceOil(HylekMaintenanceOil);
        f(base);
        *proj(base) = Utility::KraitTuningCrystal(KraitTuningCrystal);
        f(base);
        *proj(base) = Utility::MagnanimousMaintenanceOil(MagnanimousMaintenanceOil);
        f(base);
        *proj(base) = Utility::MagnanimousSharpeningStone(MagnanimousSharpeningStone);
        f(base);
        *proj(base) = Utility::MagnanimousTuningCrystal(MagnanimousTuningCrystal);
        f(base);
        *proj(base) = Utility::OgreSharpeningStone(OgreSharpeningStone);
        f(base);
        *proj(base) = Utility::PotentLucentOil(PotentLucentOil);
        f(base);
        *proj(base) = Utility::PotionOfKarkaToughness(PotionOfKarkaToughness);
        f(base);
        *proj(base) = Utility::ToxicFocusingCrystal(ToxicFocusingCrystal);
        f(base);
        *proj(base) = Utility::ToxicMaintenanceOil(ToxicMaintenanceOil);
        f(base);
        *proj(base) = Utility::ToxicSharpeningStone(ToxicSharpeningStone);
        f(base);
        *proj(base) = old;
    }
}
