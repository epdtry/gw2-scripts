...
// Generated by gen_gear_tables.py for GW2 build 142239 at 2023-03-10T02:34:15
...
impl Effect for KnownUtility {
    ...
    fn add_temporary(&self, s: &mut Stats, m: &mut Modifiers) {
        match *self {
            KnownUtility::NoUtility(x) => x.add_temporary(s, m),
            KnownUtility::BountifulSharpeningStone(x) => x.add_temporary(s, m),
            KnownUtility::BountifulTuningCrystal(x) => x.add_temporary(s, m),
            KnownUtility::CorsairMaintenanceOil(x) => x.add_temporary(s, m),
            KnownUtility::CorsairSharpeningStone(x) => x.add_temporary(s, m),
            KnownUtility::CorsairTuningCrystal(x) => x.add_temporary(s, m),
            KnownUtility::EnhancedLucentOil(x) => x.add_temporary(s, m),
            KnownUtility::FuriousMaintenanceOil(x) => x.add_temporary(s, m),
            KnownUtility::FuriousSharpeningStone(x) => x.add_temporary(s, m),
            KnownUtility::FuriousTuningCrystal(x) => x.add_temporary(s, m),
            KnownUtility::HolographicSuperApple(x) => x.add_temporary(s, m),
            KnownUtility::HolographicSuperCheese(x) => x.add_temporary(s, m),
            KnownUtility::HolographicSuperDrumstick(x) => x.add_temporary(s, m),
            KnownUtility::HylekMaintenanceOil(x) => x.add_temporary(s, m),
            KnownUtility::KraitTuningCrystal(x) => x.add_temporary(s, m),
            KnownUtility::MagnanimousMaintenanceOil(x) => x.add_temporary(s, m),
            KnownUtility::MagnanimousSharpeningStone(x) => x.add_temporary(s, m),
            KnownUtility::MagnanimousTuningCrystal(x) => x.add_temporary(s, m),
            KnownUtility::OgreSharpeningStone(x) => x.add_temporary(s, m),
            KnownUtility::PotentLucentOil(x) => x.add_temporary(s, m),
            KnownUtility::PotionOfKarkaToughness(x) => x.add_temporary(s, m),
            KnownUtility::ToxicFocusingCrystal(x) => x.add_temporary(s, m),
            KnownUtility::ToxicMaintenanceOil(x) => x.add_temporary(s, m),
            KnownUtility::ToxicSharpeningStone(x) => x.add_temporary(s, m),
        }
    }
}
