...
// Generated by gen_gear_tables.py for GW2 build 142239 at 2023-03-10T01:59:35
...
impl Sigil {
    ...
    pub fn index(self) -> usize {
        match self {
            ...
            Sigil::Agony(Agony) => 1,
            Sigil::Bursting(Bursting) => 2,
            Sigil::CentaurSlaying(CentaurSlaying) => 3,
            Sigil::Concentration(Concentration) => 4,
            Sigil::Demons(Demons) => 5,
            Sigil::Force(Force) => 6,
            Sigil::Malice(Malice) => 7,
            Sigil::Smoldering(Smoldering) => 8,
            Sigil::Venom(Venom) => 9,
        }
    }
