...
// Generated by gen_gear_tables.py for GW2 build 142239 at 2023-03-12T18:37:58
...
impl Effect for Sigil {
    ...
    fn add_temporary(&self, s: &mut Stats, m: &mut Modifiers, c: &CombatSecond) {
        match *self {
            Sigil::NoSigil(x) => x.add_temporary(s, m, c),
            Sigil::Absorption(x) => x.add_temporary(s, m, c),
            Sigil::Accuracy(x) => x.add_temporary(s, m, c),
            Sigil::Agility(x) => x.add_temporary(s, m, c),
            Sigil::Agony(x) => x.add_temporary(s, m, c),
            Sigil::Air(x) => x.add_temporary(s, m, c),
            Sigil::Battle(x) => x.add_temporary(s, m, c),
            Sigil::Benevolence(x) => x.add_temporary(s, m, c),
            Sigil::Blight(x) => x.add_temporary(s, m, c),
            Sigil::Blood(x) => x.add_temporary(s, m, c),
            Sigil::Bloodlust(x) => x.add_temporary(s, m, c),
            Sigil::Bounty(x) => x.add_temporary(s, m, c),
            Sigil::Bursting(x) => x.add_temporary(s, m, c),
            Sigil::Celerity(x) => x.add_temporary(s, m, c),
            Sigil::CentaurSlaying(x) => x.add_temporary(s, m, c),
            Sigil::Chilling(x) => x.add_temporary(s, m, c),
            Sigil::Cleansing(x) => x.add_temporary(s, m, c),
            Sigil::Concentration(x) => x.add_temporary(s, m, c),
            Sigil::Corruption(x) => x.add_temporary(s, m, c),
            Sigil::Cruelty(x) => x.add_temporary(s, m, c),
            Sigil::Debility(x) => x.add_temporary(s, m, c),
            Sigil::DemonSlaying(x) => x.add_temporary(s, m, c),
            Sigil::Demons(x) => x.add_temporary(s, m, c),
            Sigil::DestroyerSlaying(x) => x.add_temporary(s, m, c),
            Sigil::Doom(x) => x.add_temporary(s, m, c),
            Sigil::Draining(x) => x.add_temporary(s, m, c),
            Sigil::Dreams(x) => x.add_temporary(s, m, c),
            Sigil::Earth(x) => x.add_temporary(s, m, c),
            Sigil::ElementalSlaying(x) => x.add_temporary(s, m, c),
            Sigil::Energy(x) => x.add_temporary(s, m, c),
            Sigil::Fire(x) => x.add_temporary(s, m, c),
            Sigil::Force(x) => x.add_temporary(s, m, c),
            Sigil::Frailty(x) => x.add_temporary(s, m, c),
            Sigil::Frenzy(x) => x.add_temporary(s, m, c),
            Sigil::Generosity(x) => x.add_temporary(s, m, c),
            Sigil::Geomancy(x) => x.add_temporary(s, m, c),
            Sigil::GhostSlaying(x) => x.add_temporary(s, m, c),
            Sigil::GrawlSlaying(x) => x.add_temporary(s, m, c),
            Sigil::Hobbling(x) => x.add_temporary(s, m, c),
            Sigil::HologramSlaying(x) => x.add_temporary(s, m, c),
            Sigil::Hydromancy(x) => x.add_temporary(s, m, c),
            Sigil::Ice(x) => x.add_temporary(s, m, c),
            Sigil::IcebroodSlaying(x) => x.add_temporary(s, m, c),
            Sigil::Impact(x) => x.add_temporary(s, m, c),
            Sigil::Incapacitation(x) => x.add_temporary(s, m, c),
            Sigil::Justice(x) => x.add_temporary(s, m, c),
            Sigil::KarkaSlaying(x) => x.add_temporary(s, m, c),
            Sigil::Leeching(x) => x.add_temporary(s, m, c),
            Sigil::Life(x) => x.add_temporary(s, m, c),
            Sigil::Luck(x) => x.add_temporary(s, m, c),
            Sigil::MadScientists(x) => x.add_temporary(s, m, c),
            Sigil::Malice(x) => x.add_temporary(s, m, c),
            Sigil::Mischief(x) => x.add_temporary(s, m, c),
            Sigil::Momentum(x) => x.add_temporary(s, m, c),
            Sigil::Night(x) => x.add_temporary(s, m, c),
            Sigil::Nullification(x) => x.add_temporary(s, m, c),
            Sigil::OgreSlaying(x) => x.add_temporary(s, m, c),
            Sigil::Paralyzation(x) => x.add_temporary(s, m, c),
            Sigil::Perception(x) => x.add_temporary(s, m, c),
            Sigil::Peril(x) => x.add_temporary(s, m, c),
            Sigil::Purity(x) => x.add_temporary(s, m, c),
            Sigil::Rage(x) => x.add_temporary(s, m, c),
            Sigil::Rending(x) => x.add_temporary(s, m, c),
            Sigil::Renewal(x) => x.add_temporary(s, m, c),
            Sigil::Restoration(x) => x.add_temporary(s, m, c),
            Sigil::Ruthlessness(x) => x.add_temporary(s, m, c),
            Sigil::SerpentSlaying(x) => x.add_temporary(s, m, c),
            Sigil::Severance(x) => x.add_temporary(s, m, c),
            Sigil::Smoldering(x) => x.add_temporary(s, m, c),
            Sigil::Smothering(x) => x.add_temporary(s, m, c),
            Sigil::Sorrow(x) => x.add_temporary(s, m, c),
            Sigil::Speed(x) => x.add_temporary(s, m, c),
            Sigil::Stamina(x) => x.add_temporary(s, m, c),
            Sigil::Stars(x) => x.add_temporary(s, m, c),
            Sigil::Strength(x) => x.add_temporary(s, m, c),
            Sigil::Torment(x) => x.add_temporary(s, m, c),
            Sigil::Transference(x) => x.add_temporary(s, m, c),
            Sigil::UndeadSlaying(x) => x.add_temporary(s, m, c),
            Sigil::Venom(x) => x.add_temporary(s, m, c),
            Sigil::Vision(x) => x.add_temporary(s, m, c),
            Sigil::Water(x) => x.add_temporary(s, m, c),
            Sigil::Wrath(x) => x.add_temporary(s, m, c),
        }
    }
}
...
impl Effect for KnownSigil {
    ...
    fn add_temporary(&self, s: &mut Stats, m: &mut Modifiers, c: &CombatSecond) {
        match *self {
            KnownSigil::NoSigil(x) => x.add_temporary(s, m, c),
            KnownSigil::Agony(x) => x.add_temporary(s, m, c),
            KnownSigil::Bursting(x) => x.add_temporary(s, m, c),
            KnownSigil::CentaurSlaying(x) => x.add_temporary(s, m, c),
            KnownSigil::Concentration(x) => x.add_temporary(s, m, c),
            KnownSigil::Demons(x) => x.add_temporary(s, m, c),
            KnownSigil::Force(x) => x.add_temporary(s, m, c),
            KnownSigil::Malice(x) => x.add_temporary(s, m, c),
            KnownSigil::Smoldering(x) => x.add_temporary(s, m, c),
            KnownSigil::Venom(x) => x.add_temporary(s, m, c),
        }
    }
}
