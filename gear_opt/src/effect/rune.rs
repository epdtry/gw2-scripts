...
// Generated by gen_gear_tables.py for GW2 build 142239 at 2023-03-12T18:37:56
...
impl Effect for Rune {
    ...
    fn add_temporary(&self, s: &mut Stats, m: &mut Modifiers, c: &CombatSecond) {
        match *self {
            Rune::NoRune(x) => x.add_temporary(s, m, c),
            Rune::Adventurer(x) => x.add_temporary(s, m, c),
            Rune::Afflicted(x) => x.add_temporary(s, m, c),
            Rune::Air(x) => x.add_temporary(s, m, c),
            Rune::Altruism(x) => x.add_temporary(s, m, c),
            Rune::Antitoxin(x) => x.add_temporary(s, m, c),
            Rune::Aristocracy(x) => x.add_temporary(s, m, c),
            Rune::Baelfire(x) => x.add_temporary(s, m, c),
            Rune::Balthazar(x) => x.add_temporary(s, m, c),
            Rune::Berserker(x) => x.add_temporary(s, m, c),
            Rune::Brawler(x) => x.add_temporary(s, m, c),
            Rune::Cavalier(x) => x.add_temporary(s, m, c),
            Rune::Centaur(x) => x.add_temporary(s, m, c),
            Rune::Chronomancer(x) => x.add_temporary(s, m, c),
            Rune::Citadel(x) => x.add_temporary(s, m, c),
            Rune::Daredevil(x) => x.add_temporary(s, m, c),
            Rune::Deadeye(x) => x.add_temporary(s, m, c),
            Rune::Defender(x) => x.add_temporary(s, m, c),
            Rune::Divinity(x) => x.add_temporary(s, m, c),
            Rune::Dolyak(x) => x.add_temporary(s, m, c),
            Rune::Dragonhunter(x) => x.add_temporary(s, m, c),
            Rune::Druid(x) => x.add_temporary(s, m, c),
            Rune::Durability(x) => x.add_temporary(s, m, c),
            Rune::Dwayna(x) => x.add_temporary(s, m, c),
            Rune::Eagle(x) => x.add_temporary(s, m, c),
            Rune::Earth(x) => x.add_temporary(s, m, c),
            Rune::Elementalist(x) => x.add_temporary(s, m, c),
            Rune::Engineer(x) => x.add_temporary(s, m, c),
            Rune::Evasion(x) => x.add_temporary(s, m, c),
            Rune::Exuberance(x) => x.add_temporary(s, m, c),
            Rune::Fire(x) => x.add_temporary(s, m, c),
            Rune::Firebrand(x) => x.add_temporary(s, m, c),
            Rune::Fireworks(x) => x.add_temporary(s, m, c),
            Rune::FlameLegion(x) => x.add_temporary(s, m, c),
            Rune::Flock(x) => x.add_temporary(s, m, c),
            Rune::Forgeman(x) => x.add_temporary(s, m, c),
            Rune::Golemancer(x) => x.add_temporary(s, m, c),
            Rune::Grenth(x) => x.add_temporary(s, m, c),
            Rune::Grove(x) => x.add_temporary(s, m, c),
            Rune::Guardian(x) => x.add_temporary(s, m, c),
            Rune::Herald(x) => x.add_temporary(s, m, c),
            Rune::Hoelbrak(x) => x.add_temporary(s, m, c),
            Rune::Holosmith(x) => x.add_temporary(s, m, c),
            Rune::Ice(x) => x.add_temporary(s, m, c),
            Rune::Infiltration(x) => x.add_temporary(s, m, c),
            Rune::Krait(x) => x.add_temporary(s, m, c),
            Rune::Leadership(x) => x.add_temporary(s, m, c),
            Rune::Lich(x) => x.add_temporary(s, m, c),
            Rune::Lyssa(x) => x.add_temporary(s, m, c),
            Rune::MadKing(x) => x.add_temporary(s, m, c),
            Rune::Melandru(x) => x.add_temporary(s, m, c),
            Rune::Mercy(x) => x.add_temporary(s, m, c),
            Rune::Mesmer(x) => x.add_temporary(s, m, c),
            Rune::Mirage(x) => x.add_temporary(s, m, c),
            Rune::Monk(x) => x.add_temporary(s, m, c),
            Rune::NaturesBounty(x) => x.add_temporary(s, m, c),
            Rune::Necromancer(x) => x.add_temporary(s, m, c),
            Rune::Nightmare(x) => x.add_temporary(s, m, c),
            Rune::Ogre(x) => x.add_temporary(s, m, c),
            Rune::Orr(x) => x.add_temporary(s, m, c),
            Rune::Pack(x) => x.add_temporary(s, m, c),
            Rune::Perplexity(x) => x.add_temporary(s, m, c),
            Rune::Privateer(x) => x.add_temporary(s, m, c),
            Rune::Radiance(x) => x.add_temporary(s, m, c),
            Rune::Rage(x) => x.add_temporary(s, m, c),
            Rune::Ranger(x) => x.add_temporary(s, m, c),
            Rune::RataSum(x) => x.add_temporary(s, m, c),
            Rune::Reaper(x) => x.add_temporary(s, m, c),
            Rune::Rebirth(x) => x.add_temporary(s, m, c),
            Rune::Renegade(x) => x.add_temporary(s, m, c),
            Rune::Resistance(x) => x.add_temporary(s, m, c),
            Rune::Revenant(x) => x.add_temporary(s, m, c),
            Rune::Sanctuary(x) => x.add_temporary(s, m, c),
            Rune::Scavenging(x) => x.add_temporary(s, m, c),
            Rune::Scholar(x) => x.add_temporary(s, m, c),
            Rune::Scourge(x) => x.add_temporary(s, m, c),
            Rune::Scrapper(x) => x.add_temporary(s, m, c),
            Rune::Snowfall(x) => x.add_temporary(s, m, c),
            Rune::Soulbeast(x) => x.add_temporary(s, m, c),
            Rune::Speed(x) => x.add_temporary(s, m, c),
            Rune::Spellbreaker(x) => x.add_temporary(s, m, c),
            Rune::Stars(x) => x.add_temporary(s, m, c),
            Rune::Strength(x) => x.add_temporary(s, m, c),
            Rune::Sunless(x) => x.add_temporary(s, m, c),
            Rune::Surging(x) => x.add_temporary(s, m, c),
            Rune::Svanir(x) => x.add_temporary(s, m, c),
            Rune::Tempest(x) => x.add_temporary(s, m, c),
            Rune::Thief(x) => x.add_temporary(s, m, c),
            Rune::Thorns(x) => x.add_temporary(s, m, c),
            Rune::Tormenting(x) => x.add_temporary(s, m, c),
            Rune::Trapper(x) => x.add_temporary(s, m, c),
            Rune::Traveler(x) => x.add_temporary(s, m, c),
            Rune::Trooper(x) => x.add_temporary(s, m, c),
            Rune::Undead(x) => x.add_temporary(s, m, c),
            Rune::Vampirism(x) => x.add_temporary(s, m, c),
            Rune::Warrior(x) => x.add_temporary(s, m, c),
            Rune::Water(x) => x.add_temporary(s, m, c),
            Rune::Weaver(x) => x.add_temporary(s, m, c),
            Rune::Wurm(x) => x.add_temporary(s, m, c),
            Rune::Zephyrite(x) => x.add_temporary(s, m, c),
        }
    }
}
...
impl Effect for KnownRune {
    ...
    fn add_temporary(&self, s: &mut Stats, m: &mut Modifiers, c: &CombatSecond) {
        match *self {
            KnownRune::NoRune(x) => x.add_temporary(s, m, c),
            KnownRune::Adventurer(x) => x.add_temporary(s, m, c),
            KnownRune::Afflicted(x) => x.add_temporary(s, m, c),
            KnownRune::Air(x) => x.add_temporary(s, m, c),
            KnownRune::Altruism(x) => x.add_temporary(s, m, c),
            KnownRune::Antitoxin(x) => x.add_temporary(s, m, c),
            KnownRune::Aristocracy(x) => x.add_temporary(s, m, c),
            KnownRune::Baelfire(x) => x.add_temporary(s, m, c),
            KnownRune::Balthazar(x) => x.add_temporary(s, m, c),
            KnownRune::Berserker(x) => x.add_temporary(s, m, c),
            KnownRune::Brawler(x) => x.add_temporary(s, m, c),
            KnownRune::Cavalier(x) => x.add_temporary(s, m, c),
            KnownRune::Centaur(x) => x.add_temporary(s, m, c),
            KnownRune::Chronomancer(x) => x.add_temporary(s, m, c),
            KnownRune::Citadel(x) => x.add_temporary(s, m, c),
            KnownRune::Deadeye(x) => x.add_temporary(s, m, c),
            KnownRune::Defender(x) => x.add_temporary(s, m, c),
            KnownRune::Divinity(x) => x.add_temporary(s, m, c),
            KnownRune::Dolyak(x) => x.add_temporary(s, m, c),
            KnownRune::Dragonhunter(x) => x.add_temporary(s, m, c),
            KnownRune::Druid(x) => x.add_temporary(s, m, c),
            KnownRune::Durability(x) => x.add_temporary(s, m, c),
            KnownRune::Dwayna(x) => x.add_temporary(s, m, c),
            KnownRune::Eagle(x) => x.add_temporary(s, m, c),
            KnownRune::Earth(x) => x.add_temporary(s, m, c),
            KnownRune::Elementalist(x) => x.add_temporary(s, m, c),
            KnownRune::Engineer(x) => x.add_temporary(s, m, c),
            KnownRune::Evasion(x) => x.add_temporary(s, m, c),
            KnownRune::Exuberance(x) => x.add_temporary(s, m, c),
            KnownRune::Fire(x) => x.add_temporary(s, m, c),
            KnownRune::Firebrand(x) => x.add_temporary(s, m, c),
            KnownRune::Fireworks(x) => x.add_temporary(s, m, c),
            KnownRune::FlameLegion(x) => x.add_temporary(s, m, c),
            KnownRune::Flock(x) => x.add_temporary(s, m, c),
            KnownRune::Forgeman(x) => x.add_temporary(s, m, c),
            KnownRune::Golemancer(x) => x.add_temporary(s, m, c),
            KnownRune::Grove(x) => x.add_temporary(s, m, c),
            KnownRune::Guardian(x) => x.add_temporary(s, m, c),
            KnownRune::Herald(x) => x.add_temporary(s, m, c),
            KnownRune::Hoelbrak(x) => x.add_temporary(s, m, c),
            KnownRune::Holosmith(x) => x.add_temporary(s, m, c),
            KnownRune::Ice(x) => x.add_temporary(s, m, c),
            KnownRune::Krait(x) => x.add_temporary(s, m, c),
            KnownRune::Leadership(x) => x.add_temporary(s, m, c),
            KnownRune::Lich(x) => x.add_temporary(s, m, c),
            KnownRune::Lyssa(x) => x.add_temporary(s, m, c),
            KnownRune::MadKing(x) => x.add_temporary(s, m, c),
            KnownRune::Melandru(x) => x.add_temporary(s, m, c),
            KnownRune::Mercy(x) => x.add_temporary(s, m, c),
            KnownRune::Mirage(x) => x.add_temporary(s, m, c),
            KnownRune::Monk(x) => x.add_temporary(s, m, c),
            KnownRune::NaturesBounty(x) => x.add_temporary(s, m, c),
            KnownRune::Necromancer(x) => x.add_temporary(s, m, c),
            KnownRune::Nightmare(x) => x.add_temporary(s, m, c),
            KnownRune::Ogre(x) => x.add_temporary(s, m, c),
            KnownRune::Orr(x) => x.add_temporary(s, m, c),
            KnownRune::Pack(x) => x.add_temporary(s, m, c),
            KnownRune::Perplexity(x) => x.add_temporary(s, m, c),
            KnownRune::Privateer(x) => x.add_temporary(s, m, c),
            KnownRune::Radiance(x) => x.add_temporary(s, m, c),
            KnownRune::Rage(x) => x.add_temporary(s, m, c),
            KnownRune::Ranger(x) => x.add_temporary(s, m, c),
            KnownRune::RataSum(x) => x.add_temporary(s, m, c),
            KnownRune::Renegade(x) => x.add_temporary(s, m, c),
            KnownRune::Resistance(x) => x.add_temporary(s, m, c),
            KnownRune::Revenant(x) => x.add_temporary(s, m, c),
            KnownRune::Sanctuary(x) => x.add_temporary(s, m, c),
            KnownRune::Scavenging(x) => x.add_temporary(s, m, c),
            KnownRune::Scholar(x) => x.add_temporary(s, m, c),
            KnownRune::Scourge(x) => x.add_temporary(s, m, c),
            KnownRune::Snowfall(x) => x.add_temporary(s, m, c),
            KnownRune::Soulbeast(x) => x.add_temporary(s, m, c),
            KnownRune::Speed(x) => x.add_temporary(s, m, c),
            KnownRune::Stars(x) => x.add_temporary(s, m, c),
            KnownRune::Strength(x) => x.add_temporary(s, m, c),
            KnownRune::Tempest(x) => x.add_temporary(s, m, c),
            KnownRune::Thief(x) => x.add_temporary(s, m, c),
            KnownRune::Thorns(x) => x.add_temporary(s, m, c),
            KnownRune::Tormenting(x) => x.add_temporary(s, m, c),
            KnownRune::Trapper(x) => x.add_temporary(s, m, c),
            KnownRune::Traveler(x) => x.add_temporary(s, m, c),
            KnownRune::Trooper(x) => x.add_temporary(s, m, c),
            KnownRune::Undead(x) => x.add_temporary(s, m, c),
            KnownRune::Vampirism(x) => x.add_temporary(s, m, c),
            KnownRune::Warrior(x) => x.add_temporary(s, m, c),
            KnownRune::Water(x) => x.add_temporary(s, m, c),
            KnownRune::Weaver(x) => x.add_temporary(s, m, c),
            KnownRune::Wurm(x) => x.add_temporary(s, m, c),
        }
    }
}
