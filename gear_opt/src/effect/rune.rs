...
// Generated by gen_gear_tables.py for GW2 build 142239 at 2023-03-07T15:52:54
...
impl Vary for Rune {
    fn vary_at<T: ?Sized>(
        ...
        let old = *proj(base);
        *proj(base) = Rune::NoRune(NoRune);
        f(base);
        *proj(base) = Rune::Altruism(Altruism);
        f(base);
        *proj(base) = Rune::Antitoxin(Antitoxin);
        f(base);
        *proj(base) = Rune::Balthazar(Balthazar);
        f(base);
        *proj(base) = Rune::Divinity(Divinity);
        f(base);
        *proj(base) = Rune::Durability(Durability);
        f(base);
        *proj(base) = Rune::Dwayna(Dwayna);
        f(base);
        *proj(base) = Rune::Evasion(Evasion);
        f(base);
        *proj(base) = Rune::Exuberance(Exuberance);
        f(base);
        *proj(base) = Rune::Fireworks(Fireworks);
        f(base);
        *proj(base) = Rune::Hoelbrak(Hoelbrak);
        f(base);
        *proj(base) = Rune::Chronomancer(Chronomancer);
        f(base);
        *proj(base) = Rune::Leadership(Leadership);
        f(base);
        *proj(base) = Rune::Lyssa(Lyssa);
        f(base);
        *proj(base) = Rune::Melandru(Melandru);
        f(base);
        *proj(base) = Rune::Mercy(Mercy);
        f(base);
        *proj(base) = Rune::NaturesBounty(NaturesBounty);
        f(base);
        *proj(base) = Rune::Orr(Orr);
        f(base);
        *proj(base) = Rune::Perplexity(Perplexity);
        f(base);
        *proj(base) = Rune::Radiance(Radiance);
        f(base);
        *proj(base) = Rune::Rage(Rage);
        f(base);
        *proj(base) = Rune::RataSum(RataSum);
        f(base);
        *proj(base) = Rune::Resistance(Resistance);
        f(base);
        *proj(base) = Rune::Sanctuary(Sanctuary);
        f(base);
        *proj(base) = Rune::Scavenging(Scavenging);
        f(base);
        *proj(base) = Rune::Snowfall(Snowfall);
        f(base);
        *proj(base) = Rune::Speed(Speed);
        f(base);
        *proj(base) = Rune::Strength(Strength);
        f(base);
        *proj(base) = Rune::Thorns(Thorns);
        f(base);
        *proj(base) = Rune::Tormenting(Tormenting);
        f(base);
        *proj(base) = Rune::Vampirism(Vampirism);
        f(base);
        *proj(base) = Rune::Adventurer(Adventurer);
        f(base);
        *proj(base) = Rune::Afflicted(Afflicted);
        f(base);
        *proj(base) = Rune::Air(Air);
        f(base);
        *proj(base) = Rune::Aristocracy(Aristocracy);
        f(base);
        *proj(base) = Rune::Baelfire(Baelfire);
        f(base);
        *proj(base) = Rune::Berserker(Berserker);
        f(base);
        *proj(base) = Rune::Brawler(Brawler);
        f(base);
        *proj(base) = Rune::Cavalier(Cavalier);
        f(base);
        *proj(base) = Rune::Centaur(Centaur);
        f(base);
        *proj(base) = Rune::Citadel(Citadel);
        f(base);
        *proj(base) = Rune::Deadeye(Deadeye);
        f(base);
        *proj(base) = Rune::Defender(Defender);
        f(base);
        *proj(base) = Rune::Dolyak(Dolyak);
        f(base);
        *proj(base) = Rune::Dragonhunter(Dragonhunter);
        f(base);
        *proj(base) = Rune::Druid(Druid);
        f(base);
        *proj(base) = Rune::Eagle(Eagle);
        f(base);
        *proj(base) = Rune::Earth(Earth);
        f(base);
        *proj(base) = Rune::Elementalist(Elementalist);
        f(base);
        *proj(base) = Rune::Engineer(Engineer);
        f(base);
        *proj(base) = Rune::Fire(Fire);
        f(base);
        *proj(base) = Rune::Firebrand(Firebrand);
        f(base);
        *proj(base) = Rune::FlameLegion(FlameLegion);
        f(base);
        *proj(base) = Rune::Flock(Flock);
        f(base);
        *proj(base) = Rune::Forgeman(Forgeman);
        f(base);
        *proj(base) = Rune::Golemancer(Golemancer);
        f(base);
        *proj(base) = Rune::Grove(Grove);
        f(base);
        *proj(base) = Rune::Guardian(Guardian);
        f(base);
        *proj(base) = Rune::Herald(Herald);
        f(base);
        *proj(base) = Rune::Holosmith(Holosmith);
        f(base);
        *proj(base) = Rune::Ice(Ice);
        f(base);
        *proj(base) = Rune::Krait(Krait);
        f(base);
        *proj(base) = Rune::Lich(Lich);
        f(base);
        *proj(base) = Rune::MadKing(MadKing);
        f(base);
        *proj(base) = Rune::Mirage(Mirage);
        f(base);
        *proj(base) = Rune::Monk(Monk);
        f(base);
        *proj(base) = Rune::Necromancer(Necromancer);
        f(base);
        *proj(base) = Rune::Nightmare(Nightmare);
        f(base);
        *proj(base) = Rune::Ogre(Ogre);
        f(base);
        *proj(base) = Rune::Pack(Pack);
        f(base);
        *proj(base) = Rune::Privateer(Privateer);
        f(base);
        *proj(base) = Rune::Ranger(Ranger);
        f(base);
        *proj(base) = Rune::Renegade(Renegade);
        f(base);
        *proj(base) = Rune::Revenant(Revenant);
        f(base);
        *proj(base) = Rune::Scholar(Scholar);
        f(base);
        *proj(base) = Rune::Scourge(Scourge);
        f(base);
        *proj(base) = Rune::Soulbeast(Soulbeast);
        f(base);
        *proj(base) = Rune::Stars(Stars);
        f(base);
        *proj(base) = Rune::Tempest(Tempest);
        f(base);
        *proj(base) = Rune::Thief(Thief);
        f(base);
        *proj(base) = Rune::Trapper(Trapper);
        f(base);
        *proj(base) = Rune::Traveler(Traveler);
        f(base);
        *proj(base) = Rune::Trooper(Trooper);
        f(base);
        *proj(base) = Rune::Undead(Undead);
        f(base);
        *proj(base) = Rune::Warrior(Warrior);
        f(base);
        *proj(base) = Rune::Water(Water);
        f(base);
        *proj(base) = Rune::Weaver(Weaver);
        f(base);
        *proj(base) = Rune::Wurm(Wurm);
        f(base);
        *proj(base) = old;
    }
}
