...
// Generated by gen_gear_tables.py for GW2 build 142239 at 2023-03-08T15:24:54
...
impl Rune {
    ...
    pub fn index(self) -> usize {
        match self {
            ...
            Rune::Altruism(Altruism) => 1,
            Rune::Antitoxin(Antitoxin) => 2,
            Rune::Balthazar(Balthazar) => 3,
            Rune::Divinity(Divinity) => 4,
            Rune::Durability(Durability) => 5,
            Rune::Dwayna(Dwayna) => 6,
            Rune::Evasion(Evasion) => 7,
            Rune::Exuberance(Exuberance) => 8,
            Rune::Fireworks(Fireworks) => 9,
            Rune::Hoelbrak(Hoelbrak) => 10,
            Rune::Chronomancer(Chronomancer) => 11,
            Rune::Leadership(Leadership) => 12,
            Rune::Lyssa(Lyssa) => 13,
            Rune::Melandru(Melandru) => 14,
            Rune::Mercy(Mercy) => 15,
            Rune::NaturesBounty(NaturesBounty) => 16,
            Rune::Orr(Orr) => 17,
            Rune::Perplexity(Perplexity) => 18,
            Rune::Radiance(Radiance) => 19,
            Rune::Rage(Rage) => 20,
            Rune::RataSum(RataSum) => 21,
            Rune::Resistance(Resistance) => 22,
            Rune::Sanctuary(Sanctuary) => 23,
            Rune::Scavenging(Scavenging) => 24,
            Rune::Snowfall(Snowfall) => 25,
            Rune::Speed(Speed) => 26,
            Rune::Strength(Strength) => 27,
            Rune::Thorns(Thorns) => 28,
            Rune::Tormenting(Tormenting) => 29,
            Rune::Vampirism(Vampirism) => 30,
            Rune::Adventurer(Adventurer) => 31,
            Rune::Afflicted(Afflicted) => 32,
            Rune::Air(Air) => 33,
            Rune::Aristocracy(Aristocracy) => 34,
            Rune::Baelfire(Baelfire) => 35,
            Rune::Berserker(Berserker) => 36,
            Rune::Brawler(Brawler) => 37,
            Rune::Cavalier(Cavalier) => 38,
            Rune::Centaur(Centaur) => 39,
            Rune::Citadel(Citadel) => 40,
            Rune::Deadeye(Deadeye) => 41,
            Rune::Defender(Defender) => 42,
            Rune::Dolyak(Dolyak) => 43,
            Rune::Dragonhunter(Dragonhunter) => 44,
            Rune::Druid(Druid) => 45,
            Rune::Eagle(Eagle) => 46,
            Rune::Earth(Earth) => 47,
            Rune::Elementalist(Elementalist) => 48,
            Rune::Engineer(Engineer) => 49,
            Rune::Fire(Fire) => 50,
            Rune::Firebrand(Firebrand) => 51,
            Rune::FlameLegion(FlameLegion) => 52,
            Rune::Flock(Flock) => 53,
            Rune::Forgeman(Forgeman) => 54,
            Rune::Golemancer(Golemancer) => 55,
            Rune::Grove(Grove) => 56,
            Rune::Guardian(Guardian) => 57,
            Rune::Herald(Herald) => 58,
            Rune::Holosmith(Holosmith) => 59,
            Rune::Ice(Ice) => 60,
            Rune::Krait(Krait) => 61,
            Rune::Lich(Lich) => 62,
            Rune::MadKing(MadKing) => 63,
            Rune::Mirage(Mirage) => 64,
            Rune::Monk(Monk) => 65,
            Rune::Necromancer(Necromancer) => 66,
            Rune::Nightmare(Nightmare) => 67,
            Rune::Ogre(Ogre) => 68,
            Rune::Pack(Pack) => 69,
            Rune::Privateer(Privateer) => 70,
            Rune::Ranger(Ranger) => 71,
            Rune::Renegade(Renegade) => 72,
            Rune::Revenant(Revenant) => 73,
            Rune::Scholar(Scholar) => 74,
            Rune::Scourge(Scourge) => 75,
            Rune::Soulbeast(Soulbeast) => 76,
            Rune::Stars(Stars) => 77,
            Rune::Tempest(Tempest) => 78,
            Rune::Thief(Thief) => 79,
            Rune::Trapper(Trapper) => 80,
            Rune::Traveler(Traveler) => 81,
            Rune::Trooper(Trooper) => 82,
            Rune::Undead(Undead) => 83,
            Rune::Warrior(Warrior) => 84,
            Rune::Water(Water) => 85,
            Rune::Weaver(Weaver) => 86,
            Rune::Wurm(Wurm) => 87,
        }
    }
