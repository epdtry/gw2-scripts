...
// Generated by gen_gear_tables.py for GW2 build 142239 at 2023-03-12T00:54:44
...
impl Effect for Food {
    ...
    fn add_temporary(&self, s: &mut Stats, m: &mut Modifiers) {
        match *self {
            ...
            Food::FruitSaladWithMintGarnish(x) => x.add_temporary(s, m),
...
impl Effect for KnownFood {
    ...
    fn add_temporary(&self, s: &mut Stats, m: &mut Modifiers) {
        match *self {
            ...
            KnownFood::FruitSaladWithMintGarnish(x) => x.add_temporary(s, m),
