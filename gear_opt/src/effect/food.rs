...
// Generated by gen_gear_tables.py for GW2 build 142239 at 2023-03-10T01:59:37
...
impl Food {
    ...
    pub fn index(self) -> usize {
        match self {
            ...
            Food::BlockOfTofu(BlockOfTofu) => 1,
            Food::BlackPepperCactusSalad(BlackPepperCactusSalad) => 2,
            Food::CactusFruitSalad(CactusFruitSalad) => 3,
            Food::ChocolateTapiocaPudding(ChocolateTapiocaPudding) => 4,
            Food::CurryButternutSquashSoup(CurryButternutSquashSoup) => 5,
            Food::CurryPumpkinSoup(CurryPumpkinSoup) => 6,
            Food::FancyPotatoAndLeekSoup(FancyPotatoAndLeekSoup) => 7,
            Food::FireMeatChili(FireMeatChili) => 8,
            Food::FireVeggieChili(FireVeggieChili) => 9,
            Food::FishStew(FishStew) => 10,
            Food::GarlicKaleSautee(GarlicKaleSautee) => 11,
            Food::CupOfLotusFries(CupOfLotusFries) => 12,
            Food::ChocolateOmnomberryCake(ChocolateOmnomberryCake) => 13,
            Food::MarjorysExperimentalChili(MarjorysExperimentalChili) => 14,
            Food::CandyCactusCornbread(CandyCactusCornbread) => 15,
            Food::OrrianTruffleSoup(OrrianTruffleSoup) => 16,
            Food::PassionFruitTapiocaPudding(PassionFruitTapiocaPudding) => 17,
            Food::PoultrySatay(PoultrySatay) => 18,
            Food::PricklyPearSorbet(PricklyPearSorbet) => 19,
            Food::PricklyPearTapiocaPudding(PricklyPearTapiocaPudding) => 20,
            Food::RefugeesBeetSoup(RefugeesBeetSoup) => 21,
            Food::KralkachocolateBar(KralkachocolateBar) => 22,
            Food::CheesyCassavaRoll(CheesyCassavaRoll) => 23,
            Food::PricklyPearStuffedNopal(PricklyPearStuffedNopal) => 24,
            Food::SweetAndSpicyButternutSquashSoup(SweetAndSpicyButternutSquashSoup) => 25,
            Food::TropicalFruitSalad(TropicalFruitSalad) => 26,
            Food::TropicalMousse(TropicalMousse) => 27,
            Food::FrostgorgeClams(FrostgorgeClams) => 28,
            Food::TruffleRisotto(TruffleRisotto) => 29,
            Food::CarrotSouffl(CarrotSouffl) => 30,
            Food::DragonfishCandy(DragonfishCandy) => 31,
            Food::ChocolateOmnomberryCream(ChocolateOmnomberryCream) => 32,
            Food::DeliciousRiceBall(DeliciousRiceBall) => 33,
            Food::DragonsRevelryStarcake(DragonsRevelryStarcake) => 34,
            Food::FancyTruffleBurger(FancyTruffleBurger) => 35,
            Food::Flatbread(Flatbread) => 36,
            Food::IcyFishSnack(IcyFishSnack) => 37,
            Food::LakeDoricMussels(LakeDoricMussels) => 38,
            Food::OmnomberryBread(OmnomberryBread) => 39,
            Food::MushroomLoaf(MushroomLoaf) => 40,
            Food::OmnomberryCookie(OmnomberryCookie) => 41,
            Food::OystersGnashblade(OystersGnashblade) => 42,
            Food::BeefRendang(BeefRendang) => 43,
            Food::FireFlankSteak(FireFlankSteak) => 44,
            Food::JerkPoultry(JerkPoultry) => 45,
            Food::MusselsGnashblade(MusselsGnashblade) => 46,
            Food::OrrianSteakFrittes(OrrianSteakFrittes) => 47,
            Food::SpicyHerbedChicken(SpicyHerbedChicken) => 48,
            Food::SteakWithWinterberrySauce(SteakWithWinterberrySauce) => 49,
            Food::SaintBones(SaintBones) => 50,
            Food::SoulCake(SoulCake) => 51,
            Food::SoulPastry(SoulPastry) => 52,
            Food::SpicyChocolateCookie(SpicyChocolateCookie) => 53,
            Food::SpicyMarinatedMushroom(SpicyMarinatedMushroom) => 54,
        }
    }
