...
// Generated by gen_gear_tables.py for GW2 build 142239 at 2023-03-10T02:34:13
...
impl Food {
    ...
    pub fn index(self) -> usize {
        match self {
            ...
            Food::GarlicKaleSautee(GarlicKaleSautee) => 36,
            Food::GhostPepperPopper(GhostPepperPopper) => 37,
            Food::HolographicSuperCake(HolographicSuperCake) => 38,
            Food::IcyFishSnack(IcyFishSnack) => 39,
            Food::IndigoMushroomMilkshake(IndigoMushroomMilkshake) => 40,
            Food::IslandPudding(IslandPudding) => 41,
            Food::JerkPoultry(JerkPoultry) => 42,
            Food::JerkPoultryAndNopalFlatbreadSandwich(JerkPoultryAndNopalFlatbreadSandwich) => 43,
            Food::JerkPoultryFlatbreadSandwich(JerkPoultryFlatbreadSandwich) => 44,
            Food::KimchiPancakes(KimchiPancakes) => 45,
            Food::KimchiTofuStew(KimchiTofuStew) => 46,
            Food::KoiCake(KoiCake) => 47,
            Food::KralkachocolateBar(KralkachocolateBar) => 48,
            Food::LakeDoricMussels(LakeDoricMussels) => 49,
            Food::LemongrassMusselPasta(LemongrassMusselPasta) => 50,
            Food::LemongrassPoultry(LemongrassPoultry) => 51,
            Food::LemongrassPoultrySoup(LemongrassPoultrySoup) => 52,
            Food::LotusStirfry(LotusStirfry) => 53,
            Food::MangoPie(MangoPie) => 54,
            Food::MarjorysExperimentalChili(MarjorysExperimentalChili) => 55,
            Food::MashedPurplePotatoes(MashedPurplePotatoes) => 56,
            Food::MeatyAsparagusSkewer(MeatyAsparagusSkewer) => 57,
            Food::MeatyRiceBowl(MeatyRiceBowl) => 58,
            Food::MushroomLoaf(MushroomLoaf) => 59,
            Food::MushroomsYakkington(MushroomsYakkington) => 60,
            Food::MusselSoup(MusselSoup) => 61,
            Food::MusselsGnashblade(MusselsGnashblade) => 62,
            Food::NopalitosSaut(NopalitosSaut) => 63,
            Food::OmnomberryBar(OmnomberryBar) => 64,
            Food::OmnomberryBread(OmnomberryBread) => 65,
            Food::OmnomberryCompote(OmnomberryCompote) => 66,
            Food::OmnomberryCookie(OmnomberryCookie) => 67,
            Food::OmnomberryGhost(OmnomberryGhost) => 68,
            Food::OmnomberryPie(OmnomberryPie) => 69,
            Food::OmnomberryTart(OmnomberryTart) => 70,
            Food::OrrianSteakFrittes(OrrianSteakFrittes) => 71,
            Food::OrrianTruffleAndMeatStew(OrrianTruffleAndMeatStew) => 72,
            Food::OrrianTruffleSoup(OrrianTruffleSoup) => 73,
            Food::OystersGnashblade(OystersGnashblade) => 74,
            Food::OystersWithCocktailSauce(OystersWithCocktailSauce) => 75,
            Food::OystersWithPestoSauce(OystersWithPestoSauce) => 76,
            Food::OystersWithSpicySauce(OystersWithSpicySauce) => 77,
            Food::OystersWithZestySauce(OystersWithZestySauce) => 78,
            Food::PassionFruitTapiocaPudding(PassionFruitTapiocaPudding) => 79,
            Food::PeppermintOmnomberryBar(PeppermintOmnomberryBar) => 80,
            Food::PoultrySatay(PoultrySatay) => 81,
            Food::PricklyPearPie(PricklyPearPie) => 82,
            Food::PricklyPearSorbet(PricklyPearSorbet) => 83,
            Food::PricklyPearStuffedNopal(PricklyPearStuffedNopal) => 84,
            Food::PricklyPearTapiocaPudding(PricklyPearTapiocaPudding) => 85,
            Food::QuicheOfDarkness(QuicheOfDarkness) => 86,
            Food::RareVeggiePizza(RareVeggiePizza) => 87,
            Food::RedLentilSaobosa(RedLentilSaobosa) => 88,
            Food::RedfishSushi(RedfishSushi) => 89,
            Food::RefugeesBeetSoup(RefugeesBeetSoup) => 90,
            Food::RoastedCactus(RoastedCactus) => 91,
            Food::RoastedLotusRoot(RoastedLotusRoot) => 92,
            Food::SaffronBread(SaffronBread) => 93,
            Food::SaffronMangoIceCream(SaffronMangoIceCream) => 94,
            Food::SaffronMussels(SaffronMussels) => 95,
            Food::SaffronStuffedMushroom(SaffronStuffedMushroom) => 96,
            Food::SaffronscentedPoultrySoup(SaffronscentedPoultrySoup) => 97,
            Food::SaintBones(SaintBones) => 98,
            Food::ScoopOfMintberrySwirlIceCream(ScoopOfMintberrySwirlIceCream) => 99,
            Food::SeaweedSalad(SeaweedSalad) => 100,
            Food::SliceOfAllspiceCake(SliceOfAllspiceCake) => 101,
            Food::SliceOfAllspiceCakeWithIceCream(SliceOfAllspiceCakeWithIceCream) => 102,
            Food::SliceOfCandiedDragonRoll(SliceOfCandiedDragonRoll) => 103,
            Food::SoulCake(SoulCake) => 104,
            Food::SoulPastry(SoulPastry) => 105,
            Food::SpicyChocolateCookie(SpicyChocolateCookie) => 106,
            Food::SpicyHerbedChicken(SpicyHerbedChicken) => 107,
            Food::SpicyMarinatedMushroom(SpicyMarinatedMushroom) => 108,
            Food::SpicyPumpkinCookie(SpicyPumpkinCookie) => 109,
            Food::SpringRoll(SpringRoll) => 110,
            Food::SteakWithWinterberrySauce(SteakWithWinterberrySauce) => 111,
            Food::SteamedRedDumpling(SteamedRedDumpling) => 112,
            Food::SuperHotLemongrassPoultrySoup(SuperHotLemongrassPoultrySoup) => 113,
            Food::SuperHotSaffronScentedPoultrySoup(SuperHotSaffronScentedPoultrySoup) => 114,
            Food::SweetAndSpicyBeans(SweetAndSpicyBeans) => 115,
            Food::SweetAndSpicyButternutSquashSoup(SweetAndSpicyButternutSquashSoup) => 116,
            Food::SweetBeanBun(SweetBeanBun) => 117,
            Food::SweetCurriedMussels(SweetCurriedMussels) => 118,
            Food::SwiftlyScrambledEggs(SwiftlyScrambledEggs) => 119,
            Food::TapiocaPudding(TapiocaPudding) => 120,
            Food::TropicalFruitSalad(TropicalFruitSalad) => 121,
            Food::TropicalMousse(TropicalMousse) => 122,
            Food::TropicalPeppermintCake(TropicalPeppermintCake) => 123,
            Food::TruffleRavioli(TruffleRavioli) => 124,
            Food::TruffleRisotto(TruffleRisotto) => 125,
            Food::TruffleSautee(TruffleSautee) => 126,
            Food::TruffleSteak(TruffleSteak) => 127,
            Food::TruffleSteakDinner(TruffleSteakDinner) => 128,
            Food::WinterberryPie(WinterberryPie) => 129,
            Food::WinterberrySeaweedSalad(WinterberrySeaweedSalad) => 130,
            Food::WinterberrySorbet(WinterberrySorbet) => 131,
            Food::ZestyTurnipSoup(ZestyTurnipSoup) => 132,
        }
    }
    pub fn from_index(i: usize) -> Food {
        match i {
            ...
            36 => Food::GarlicKaleSautee(GarlicKaleSautee),
            37 => Food::GhostPepperPopper(GhostPepperPopper),
            38 => Food::HolographicSuperCake(HolographicSuperCake),
            39 => Food::IcyFishSnack(IcyFishSnack),
            40 => Food::IndigoMushroomMilkshake(IndigoMushroomMilkshake),
            41 => Food::IslandPudding(IslandPudding),
            42 => Food::JerkPoultry(JerkPoultry),
            43 => Food::JerkPoultryAndNopalFlatbreadSandwich(JerkPoultryAndNopalFlatbreadSandwich),
            44 => Food::JerkPoultryFlatbreadSandwich(JerkPoultryFlatbreadSandwich),
            45 => Food::KimchiPancakes(KimchiPancakes),
            46 => Food::KimchiTofuStew(KimchiTofuStew),
            47 => Food::KoiCake(KoiCake),
            48 => Food::KralkachocolateBar(KralkachocolateBar),
            49 => Food::LakeDoricMussels(LakeDoricMussels),
            50 => Food::LemongrassMusselPasta(LemongrassMusselPasta),
            51 => Food::LemongrassPoultry(LemongrassPoultry),
            52 => Food::LemongrassPoultrySoup(LemongrassPoultrySoup),
            53 => Food::LotusStirfry(LotusStirfry),
            54 => Food::MangoPie(MangoPie),
            55 => Food::MarjorysExperimentalChili(MarjorysExperimentalChili),
            56 => Food::MashedPurplePotatoes(MashedPurplePotatoes),
            57 => Food::MeatyAsparagusSkewer(MeatyAsparagusSkewer),
            58 => Food::MeatyRiceBowl(MeatyRiceBowl),
            59 => Food::MushroomLoaf(MushroomLoaf),
            60 => Food::MushroomsYakkington(MushroomsYakkington),
            61 => Food::MusselSoup(MusselSoup),
            62 => Food::MusselsGnashblade(MusselsGnashblade),
            63 => Food::NopalitosSaut(NopalitosSaut),
            64 => Food::OmnomberryBar(OmnomberryBar),
            65 => Food::OmnomberryBread(OmnomberryBread),
            66 => Food::OmnomberryCompote(OmnomberryCompote),
            67 => Food::OmnomberryCookie(OmnomberryCookie),
            68 => Food::OmnomberryGhost(OmnomberryGhost),
            69 => Food::OmnomberryPie(OmnomberryPie),
            70 => Food::OmnomberryTart(OmnomberryTart),
            71 => Food::OrrianSteakFrittes(OrrianSteakFrittes),
            72 => Food::OrrianTruffleAndMeatStew(OrrianTruffleAndMeatStew),
            73 => Food::OrrianTruffleSoup(OrrianTruffleSoup),
            74 => Food::OystersGnashblade(OystersGnashblade),
            75 => Food::OystersWithCocktailSauce(OystersWithCocktailSauce),
            76 => Food::OystersWithPestoSauce(OystersWithPestoSauce),
            77 => Food::OystersWithSpicySauce(OystersWithSpicySauce),
            78 => Food::OystersWithZestySauce(OystersWithZestySauce),
            79 => Food::PassionFruitTapiocaPudding(PassionFruitTapiocaPudding),
            80 => Food::PeppermintOmnomberryBar(PeppermintOmnomberryBar),
            81 => Food::PoultrySatay(PoultrySatay),
            82 => Food::PricklyPearPie(PricklyPearPie),
            83 => Food::PricklyPearSorbet(PricklyPearSorbet),
            84 => Food::PricklyPearStuffedNopal(PricklyPearStuffedNopal),
            85 => Food::PricklyPearTapiocaPudding(PricklyPearTapiocaPudding),
            86 => Food::QuicheOfDarkness(QuicheOfDarkness),
            87 => Food::RareVeggiePizza(RareVeggiePizza),
            88 => Food::RedLentilSaobosa(RedLentilSaobosa),
            89 => Food::RedfishSushi(RedfishSushi),
            90 => Food::RefugeesBeetSoup(RefugeesBeetSoup),
            91 => Food::RoastedCactus(RoastedCactus),
            92 => Food::RoastedLotusRoot(RoastedLotusRoot),
            93 => Food::SaffronBread(SaffronBread),
            94 => Food::SaffronMangoIceCream(SaffronMangoIceCream),
            95 => Food::SaffronMussels(SaffronMussels),
            96 => Food::SaffronStuffedMushroom(SaffronStuffedMushroom),
            97 => Food::SaffronscentedPoultrySoup(SaffronscentedPoultrySoup),
            98 => Food::SaintBones(SaintBones),
            99 => Food::ScoopOfMintberrySwirlIceCream(ScoopOfMintberrySwirlIceCream),
            100 => Food::SeaweedSalad(SeaweedSalad),
            101 => Food::SliceOfAllspiceCake(SliceOfAllspiceCake),
            102 => Food::SliceOfAllspiceCakeWithIceCream(SliceOfAllspiceCakeWithIceCream),
            103 => Food::SliceOfCandiedDragonRoll(SliceOfCandiedDragonRoll),
            104 => Food::SoulCake(SoulCake),
            105 => Food::SoulPastry(SoulPastry),
            106 => Food::SpicyChocolateCookie(SpicyChocolateCookie),
            107 => Food::SpicyHerbedChicken(SpicyHerbedChicken),
            108 => Food::SpicyMarinatedMushroom(SpicyMarinatedMushroom),
            109 => Food::SpicyPumpkinCookie(SpicyPumpkinCookie),
            110 => Food::SpringRoll(SpringRoll),
            111 => Food::SteakWithWinterberrySauce(SteakWithWinterberrySauce),
            112 => Food::SteamedRedDumpling(SteamedRedDumpling),
            113 => Food::SuperHotLemongrassPoultrySoup(SuperHotLemongrassPoultrySoup),
            114 => Food::SuperHotSaffronScentedPoultrySoup(SuperHotSaffronScentedPoultrySoup),
            115 => Food::SweetAndSpicyBeans(SweetAndSpicyBeans),
            116 => Food::SweetAndSpicyButternutSquashSoup(SweetAndSpicyButternutSquashSoup),
            117 => Food::SweetBeanBun(SweetBeanBun),
            118 => Food::SweetCurriedMussels(SweetCurriedMussels),
            119 => Food::SwiftlyScrambledEggs(SwiftlyScrambledEggs),
            120 => Food::TapiocaPudding(TapiocaPudding),
            121 => Food::TropicalFruitSalad(TropicalFruitSalad),
            122 => Food::TropicalMousse(TropicalMousse),
            123 => Food::TropicalPeppermintCake(TropicalPeppermintCake),
            124 => Food::TruffleRavioli(TruffleRavioli),
            125 => Food::TruffleRisotto(TruffleRisotto),
            126 => Food::TruffleSautee(TruffleSautee),
            127 => Food::TruffleSteak(TruffleSteak),
            128 => Food::TruffleSteakDinner(TruffleSteakDinner),
            129 => Food::WinterberryPie(WinterberryPie),
            130 => Food::WinterberrySeaweedSalad(WinterberrySeaweedSalad),
            131 => Food::WinterberrySorbet(WinterberrySorbet),
            132 => Food::ZestyTurnipSoup(ZestyTurnipSoup),
...
impl Vary for Food {
    ...
    fn num_field_values(&self, _field: usize) -> u16 { 133 }
...
impl KnownFood {
    ...
    pub fn index(self) -> usize {
        match self {
            ...
            KnownFood::GarlicKaleSautee(GarlicKaleSautee) => 25,
            KnownFood::IcyFishSnack(IcyFishSnack) => 26,
            KnownFood::JerkPoultry(JerkPoultry) => 27,
            KnownFood::KralkachocolateBar(KralkachocolateBar) => 28,
            KnownFood::LakeDoricMussels(LakeDoricMussels) => 29,
            KnownFood::MarjorysExperimentalChili(MarjorysExperimentalChili) => 30,
            KnownFood::MushroomLoaf(MushroomLoaf) => 31,
            KnownFood::MusselsGnashblade(MusselsGnashblade) => 32,
            KnownFood::OmnomberryBread(OmnomberryBread) => 33,
            KnownFood::OmnomberryCookie(OmnomberryCookie) => 34,
            KnownFood::OrrianSteakFrittes(OrrianSteakFrittes) => 35,
            KnownFood::OrrianTruffleSoup(OrrianTruffleSoup) => 36,
            KnownFood::OystersGnashblade(OystersGnashblade) => 37,
            KnownFood::PassionFruitTapiocaPudding(PassionFruitTapiocaPudding) => 38,
            KnownFood::PoultrySatay(PoultrySatay) => 39,
    ...
    pub fn from_index(i: usize) -> KnownFood {
        match i {
            ...
            25 => KnownFood::GarlicKaleSautee(GarlicKaleSautee),
            26 => KnownFood::IcyFishSnack(IcyFishSnack),
            27 => KnownFood::JerkPoultry(JerkPoultry),
            28 => KnownFood::KralkachocolateBar(KralkachocolateBar),
            29 => KnownFood::LakeDoricMussels(LakeDoricMussels),
            30 => KnownFood::MarjorysExperimentalChili(MarjorysExperimentalChili),
            31 => KnownFood::MushroomLoaf(MushroomLoaf),
            32 => KnownFood::MusselsGnashblade(MusselsGnashblade),
            33 => KnownFood::OmnomberryBread(OmnomberryBread),
            34 => KnownFood::OmnomberryCookie(OmnomberryCookie),
            35 => KnownFood::OrrianSteakFrittes(OrrianSteakFrittes),
            36 => KnownFood::OrrianTruffleSoup(OrrianTruffleSoup),
            37 => KnownFood::OystersGnashblade(OystersGnashblade),
            38 => KnownFood::PassionFruitTapiocaPudding(PassionFruitTapiocaPudding),
            39 => KnownFood::PoultrySatay(PoultrySatay),
    ...
    pub fn display_name(self) -> &'static str {
        match self {
            ...
            KnownFood::PoultrySatay(x) => x.display_name(),
...
impl Effect for KnownFood {
    fn add_permanent(&self, s: &mut Stats, m: &mut Modifiers) {
        match *self {
            ...
            KnownFood::PoultrySatay(x) => x.add_permanent(s, m),
    ...
    fn distribute(&self, s: &mut Stats, m: &mut Modifiers) {
        match *self {
            ...
            KnownFood::PoultrySatay(x) => x.distribute(s, m),
    ...
    fn add_temporary(&self, s: &mut Stats, m: &mut Modifiers) {
        match *self {
            KnownFood::NoFood(x) => x.add_temporary(s, m),
            KnownFood::BeefRendang(x) => x.add_temporary(s, m),
            KnownFood::BlackPepperCactusSalad(x) => x.add_temporary(s, m),
            KnownFood::BlockOfTofu(x) => x.add_temporary(s, m),
            KnownFood::CactusFruitSalad(x) => x.add_temporary(s, m),
            KnownFood::CandyCactusCornbread(x) => x.add_temporary(s, m),
            KnownFood::CarrotSouffl(x) => x.add_temporary(s, m),
            KnownFood::CheesyCassavaRoll(x) => x.add_temporary(s, m),
            KnownFood::ChocolateOmnomberryCake(x) => x.add_temporary(s, m),
            KnownFood::ChocolateOmnomberryCream(x) => x.add_temporary(s, m),
            KnownFood::ChocolateTapiocaPudding(x) => x.add_temporary(s, m),
            KnownFood::CupOfLotusFries(x) => x.add_temporary(s, m),
            KnownFood::CurryButternutSquashSoup(x) => x.add_temporary(s, m),
            KnownFood::CurryPumpkinSoup(x) => x.add_temporary(s, m),
            KnownFood::DeliciousRiceBall(x) => x.add_temporary(s, m),
            KnownFood::DragonfishCandy(x) => x.add_temporary(s, m),
            KnownFood::DragonsRevelryStarcake(x) => x.add_temporary(s, m),
            KnownFood::FancyPotatoAndLeekSoup(x) => x.add_temporary(s, m),
            KnownFood::FancyTruffleBurger(x) => x.add_temporary(s, m),
            KnownFood::FireFlankSteak(x) => x.add_temporary(s, m),
            KnownFood::FireMeatChili(x) => x.add_temporary(s, m),
            KnownFood::FireVeggieChili(x) => x.add_temporary(s, m),
            KnownFood::FishStew(x) => x.add_temporary(s, m),
            KnownFood::Flatbread(x) => x.add_temporary(s, m),
            KnownFood::FrostgorgeClams(x) => x.add_temporary(s, m),
            KnownFood::GarlicKaleSautee(x) => x.add_temporary(s, m),
            KnownFood::IcyFishSnack(x) => x.add_temporary(s, m),
            KnownFood::JerkPoultry(x) => x.add_temporary(s, m),
            KnownFood::KralkachocolateBar(x) => x.add_temporary(s, m),
            KnownFood::LakeDoricMussels(x) => x.add_temporary(s, m),
            KnownFood::MarjorysExperimentalChili(x) => x.add_temporary(s, m),
            KnownFood::MushroomLoaf(x) => x.add_temporary(s, m),
            KnownFood::MusselsGnashblade(x) => x.add_temporary(s, m),
            KnownFood::OmnomberryBread(x) => x.add_temporary(s, m),
            KnownFood::OmnomberryCookie(x) => x.add_temporary(s, m),
            KnownFood::OrrianSteakFrittes(x) => x.add_temporary(s, m),
            KnownFood::OrrianTruffleSoup(x) => x.add_temporary(s, m),
            KnownFood::OystersGnashblade(x) => x.add_temporary(s, m),
            KnownFood::PassionFruitTapiocaPudding(x) => x.add_temporary(s, m),
            KnownFood::PoultrySatay(x) => x.add_temporary(s, m),
            KnownFood::PricklyPearSorbet(x) => x.add_temporary(s, m),
            KnownFood::PricklyPearStuffedNopal(x) => x.add_temporary(s, m),
            KnownFood::PricklyPearTapiocaPudding(x) => x.add_temporary(s, m),
            KnownFood::RefugeesBeetSoup(x) => x.add_temporary(s, m),
            KnownFood::SaintBones(x) => x.add_temporary(s, m),
            KnownFood::SoulCake(x) => x.add_temporary(s, m),
            KnownFood::SoulPastry(x) => x.add_temporary(s, m),
            KnownFood::SpicyChocolateCookie(x) => x.add_temporary(s, m),
            KnownFood::SpicyHerbedChicken(x) => x.add_temporary(s, m),
            KnownFood::SpicyMarinatedMushroom(x) => x.add_temporary(s, m),
            KnownFood::SteakWithWinterberrySauce(x) => x.add_temporary(s, m),
            KnownFood::SweetAndSpicyButternutSquashSoup(x) => x.add_temporary(s, m),
            KnownFood::TropicalFruitSalad(x) => x.add_temporary(s, m),
            KnownFood::TropicalMousse(x) => x.add_temporary(s, m),
            KnownFood::TruffleRisotto(x) => x.add_temporary(s, m),
        }
    }
}
...
impl From<PoultrySatay> for KnownFood {
    fn from(x: PoultrySatay) -> KnownFood { KnownFood::PoultrySatay(x) }
}
...
impl Food {
    ...
    pub fn as_known(self) -> KnownFood {
        match self {
            ...
            Food::PoultrySatay(PoultrySatay) => KnownFood::PoultrySatay(PoultrySatay),
...
impl PoultrySatay {
    pub fn as_known(self) -> KnownFood {
        KnownFood::PoultrySatay(PoultrySatay)
    }
}
impl PricklyPearPie {
    pub fn as_known(self) -> KnownFood {
...
impl From<KnownFood> for Food {
    fn from(x: KnownFood) -> Food {
        match x {
            ...
            KnownFood::PoultrySatay(y) => Food::PoultrySatay(y),
